            ...
            <div class="box-body no-padding">
              <table class="table">
                ...
                <tr>
                  ...
                  <td>
                   <a style="cursor: pointer; color:white ;" title="" onclick="href='<?php echo base_url(('admin/hapus_bandara/'.$t->id)); ?>'"> <button class="btn btn-danger" style="height: 26px; padding: 2px; padding-left: 10px; padding-right: 10px;">Remove</button></a>
                </tr>
                <?php } ?>
              </table>
            </div>
