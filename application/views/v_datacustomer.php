      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><a href="<?php echo base_url("admin/customer"); ?>"><button class="btn btn-primary">Tambah</button></a></h3>
          </div>
          <div class="box-body">
              ...
              <tbody>
               ...
               foreach($customer as $t){ 
                ...
                <tr>
                  ...
                  <td>
                    <a style="cursor: pointer; color:white;" title="" onclick="href='<?php echo base_url(('admin/hapus_datacustomer/'.$t->id)); ?>'"><button class="btn btn-danger glyphicon glyphicon-trash"></button></a> 
                    <a style="cursor: pointer; color:white ;" title="" onclick="href='<?php echo base_url(('admin/edit_datacustomer/'.$t->id)); ?>'"> <button class="btn btn-danger glyphicon glyphicon-edit"></button></a> 
                  </td>
                </tr>
                <?php } ?>
              </tbody>
