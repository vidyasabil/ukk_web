              ...
              <tbody>
               ...
               foreach($transportation as $t){ 
                ...
                <tr>
                  ...
                  <td><?php echo $t->sitqty ?></td>
                  <td>
                    <a style="cursor: pointer; color:white;" title="" onclick="href='<?php echo base_url(('admin/hapus_datamaskapai/'.$t->id)); ?>'"><button class="btn btn-danger glyphicon glyphicon-trash"></button></a>
                    <a style="cursor: pointer; color:white ;" title="" onclick="href='<?php echo base_url(('admin/edit_datamaskapai/'.$t->id)); ?>'"> <button class="btn btn-danger glyphicon glyphicon-edit"></button></a> 
                  </td>
                </tr>
                <?php } ?>
              </tbody>
