...
<!-- //Custom Theme files -->
<link href="<?php echo base_url();?>/web/css/bootstrap.css" type="text/css" rel="stylesheet" media="all">
<link href="<?php echo base_url();?>/web/css/style.css" type="text/css" rel="stylesheet" media="all">
<link rel="stylesheet" href="<?php echo base_url();?>/web/css/flexslider.css" type="text/css" media="screen" />
<link type="text/css" rel="stylesheet" href="<?php echo base_url();?>/web/css/JFFormStyle-1.css" />
<!-- js -->
...
<!--pop-up-->
<script src="<?php echo base_url();?>/web/js/menu_jquery.js"></script>
<!--//pop-up-->	
</head>
<body>
	<!--header-->
	<div class="header">
		<div class="container">
			<div class="header-grids">
				<div class="logo">
					<h1><a  href="index.html"><span>Travel</span>Flight</a></h1>
				</div>
				<!--navbar-header-->
			...
			<div class="nav-top">
				<div class="top-nav">
					<span class="menu"><img src="<?php echo base_url();?>/web/images/menu.png" alt="" /></span>
					<ul class="nav1">
				...
				<div class="dropdown-grids">
						<div id="loginContainer"><a href="<?php echo base_url(); ?>/login" id="loginButton"><span>Login</span></a><br>
							<div id="loginBox">                
								<form id="loginForm">
						...
						<ul class="slides">
							<li>
								<div class="slider-info">
									<img src="<?php echo base_url();?>/web/images/1.jpg" alt="">
								</div>
							</li>
							<li>
								<div class="slider-info">
									<img src="<?php echo base_url();?>/web/images/2.jpg" alt="">
								</div>
							</li>
							<li>	
								<div class="slider-info">
									<img src="<?php echo base_url();?>/web/images/3.jpg" alt="">
								</div>
							</li>
							<li>	
								<div class="slider-info">
									<img src="<?php echo base_url();?>/web/images/4.jpg" alt="">
								</div>
							</li>
							<li>	
								<div class="slider-info">
	...
	<div class="move-text">
		...
		<script type="text/javascript" src="<?php echo base_url();?>/web/js/jquery.marquee.min.js"></script>
        <script>
			...
			<div class="banner-bottom-grids">
						 ...
						 <ul>
								...
								<li class="dropdown active">
									<a href="products.html">
										<div class="destinations-grid">
											<img src="<?php echo base_url();?>/web/images/a1.jpg" alt="" />
										</div>
							...
							<li class="button"><a href="#">Bangalore Popular Hotels</a>
								<li class="dropdown">
									<a href="products.html">
										<div class="destinations-grid">
											<img src="<?php echo base_url();?>/web/images/a4.jpg" alt="" />
										</div>
										<div class="destinations-grid-info">
							...
							<li class="button"><a href="#">Bangkok Popular Hotels</a>
								 <li class="dropdown">
									<a href="products">
										<div class="destinations-grid">
											<img src="<?php echo base_url();?>/web/images/a3.jpg" alt="" />
										</div>
										<div class="destinations-grid-info">
				...
				<div class="col-md-4 banner-bottom-grid">
					<div class="banner-bottom-middle">
						<a href="products.html">
							<img src="<?php echo base_url();?>/web/images/a2.jpg" alt="" />
					...
					<div class="top-destinations-grids">
						...
						<div class="top-destinations-bottom">
							...
							<div class="td-grids">
								<div class="col-xs-3 td-left">
									<img src="<?php echo base_url();?>/web/images/t3.jpg" alt="" />
								</div>
								<div class="col-xs-7 td-middle">
									<a href="products.html">Donec libero id lacinia</a>
									<p>Dapibus eu purus vel libero in nunc</p>
		...
		<div class="container">
			...
			<div class="slider">
				<div class="arrival-grids">			 
					 <ul id="flexiselDemo1">
						 <li>
							 <a href="products.html"><img src="<?php echo base_url();?>/web/images/a3.jpg" alt=""/>
							 </a>
						 </li>
						 <li>
							 <a href="products.html"><img src="<?php echo base_url();?>/web/images/a2.jpg" alt=""/>
							 </a>
						 </li>
						 <li>
							 <a href="products.html"><img src="<?php echo base_url();?>/web/images/a4.jpg" alt=""/>
							 </a>
						 </li>
						 <li>
							 <a href="products.html"><img src="<?php echo base_url();?>/web/images/a1.jpg" alt=""/>
							 </a>
						 </li>
						</ul>
						<script type="text/javascript">
		...
		<div class="container">
				<div class="footer-bottom-top-grids">
					<div class="col-md-4 footer-bottom-left">
						...
						<div class="d-apps">
							<ul>
								<li><a href="#"><img src="<?php echo base_url();?>/web/<?php echo base_url();?>/web/images/app1.png" alt="" /></a></li>
								<li><a href="#"><img src="<?php echo base_url();?>/web/<?php echo base_url();?>/web/images/app2.png" alt="" /></a></a></li>
								<li><a href="#"><img src="<?php echo base_url();?>/web/<?php echo base_url();?>/web/images/app3.png" alt="" /></a></a></li>
							</ul>
						</div>
					</div>
					<div class="col-md-4 footer-bottom-left">
						...
						<div class="a-cards">
							<ul>
								<li><a href="#"><img src="<?php echo base_url();?>/web/<?php echo base_url();?>/web/<?php echo base_url();?>/web/images/c1.png" alt="" /></a></li>
								<li><a href="#"><img src="<?php echo base_url();?>/web/<?php echo base_url();?>/web/<?php echo base_url();?>/web/images/c2.png" alt="" /></a></a></li>
								<li><a href="#"><img src="<?php echo base_url();?>/web/<?php echo base_url();?>/web/<?php echo base_url();?>/web/images/c3.png" alt="" /></a></a></li>
							</ul>
						</div>
					</div>
					<div class="col-md-4 footer-bottom-left">
	...
	<script defer src="<?php echo base_url();?>/web/<?php echo base_url();?>/web/<?php echo base_url();?>/web/<?php echo base_url();?>/web/js/jquery.flexslider.js"></script>
	<script src="<?php echo base_url();?>/web/<?php echo base_url();?>/web/<?php echo base_url();?>/web/<?php echo base_url();?>/web/js/easyResponsiveTabs.js" type="text/javascript"></script>
	<script src="<?php echo base_url();?>/web/<?php echo base_url();?>/web/<?php echo base_url();?>/web/<?php echo base_url();?>/web/js/jquery-ui.js"></script>
	<script type="text/javascript" src="<?php echo base_url();?>/web/<?php echo base_url();?>/web/<?php echo base_url();?>/web/<?php echo base_url();?>/web/js/script.js"></script>
	<script type="text/javascript">
		$(function(){
