...
<head>
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>gudang/adminlte/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
  <!-- Theme style -->
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><a href="<?php echo base_url("admin/bandara"); ?>"><button class="btn btn-primary">Tambah</button></a></h3>
          </div>
          <div class="box-body">
              ...
              <tbody>
               ...
               foreach($bandara as $t){ 
                ...
                <tr>
                  ...
                  <td>
                    <a style="cursor: pointer; color:white;" title="" onclick="href='<?php echo base_url(('admin/hapus_bandara/'.$t->id)); ?>'"><button class="btn btn-danger glyphicon glyphicon-trash"></button></a>
                    <a style="cursor: pointer; color:white ;" title="" onclick="href='<?php echo base_url(('admin/edit_bandara/'.$t->id)); ?>'"> <button class="btn btn-danger glyphicon glyphicon-edit"></button></a> 
...
<!-- DataTables -->
<script src="<?php echo base_url(); ?>gudang/adminlte/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="<?php echo base_url(); ?>gudang/adminlte/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
<!-- SlimScroll -->
